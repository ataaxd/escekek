...
if contoh =="1":
   jum = int(input(f"{yellow}{green}[{red}◕ {yellow}◕ {red}◕{green}] {white}JUMLAH:{red} "))
   teh()
elif contoh =="0":
   jum = int(input(f"{yellow}{green}[{red}◕ {yellow}◕ {red}◕{green}] {white}JUMLAH:{red} "))
   ngopi()
elif contoh =="2":
   haya = int(input(f"{yellow}{green}[{red}◕ {yellow}◕ {red}◕{green}] {white}JUMLAH:{red} "))
   ngopii()
elif contoh =="3":
     gcg = int(input(f"{yellow}{green}[{red}◕ {yellow}◕ {red}◕{green}] {white}JUMLAH:{red} "))
     crot()
elif contoh =="4":
     blok = int(input(f"{yellow}{green}[{red}◕ {yellow}◕ {red}◕{green}] {white}JUMLAH:{red} "))
